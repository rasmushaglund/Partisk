 ...
 */
   	...
   	$error = $sameMode && 
                isset($validationErrors[$model][$field]) ? $validationErrors[$model][$field][0] : null;
...
<div class="input text required form-group">
    ...
    <?php } ?>
    <input name="<?php echo "data[$model][$field]"; ?>" type="<?php echo $type; ?>" value="<?php echo $value; ?>" 
               id="<?php echo $id; ?>" class="form-control" placeholder="<?php echo $placeholder; ?>" autocomplete="off">
</div>