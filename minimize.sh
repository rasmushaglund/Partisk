...
yuglify app/webroot/js/jquery.js app/webroot/js/bootstrap.js app/webroot/js/bootstrap-datepicker.js app/webroot/js/typeahead.js app/webroot/js/bootstrap-datepicker.sv.js app/webroot/js/partisk.js -c app/webroot/js/partisk
